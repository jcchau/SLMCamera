classdef ImagingReceiver < CameraArray
    ...
    methods
        ...
        function [l, cos_theta, cos_phi] = ...
            ...
            %
            % TODO: A CameraArray object would be sufficient for this
            % method; move this method to the CameraArray class.
            ...
            if(~all(ray_intersects))
                error('ImagingReceiver:BadPixelProjection', ...
            ...
            if(any(is_parallel))
                warning('ImagingReceiver:ParallelPixelProjection', ...
                    'The pixel projection ray is parallel to TRANSMITTER_PLANE.  L may be incorrected.');
        ...
        end % function calculateFineRelativePosition
    end % methods
