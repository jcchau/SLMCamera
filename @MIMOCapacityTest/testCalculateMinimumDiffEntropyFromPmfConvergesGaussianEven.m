function testCalculateMinimumDiffEntropyFromPmfConvergesGaussianEven(tc)
% testCalculateMinimumDiffEntropyFromPmfConvergesGaussianEven verifies
% using a Gaussian RV that as the number of bins increase, the difference
% between the true and minimum differential entropy approaches zero.
%
% Here, we only use even numbers of bins (so that the difference between
