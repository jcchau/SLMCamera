...
% ImagingReceiver.generateReceivedPmfForUniformInput works even when
...
tc.verifyGreaterThanOrEqual(trials, min_trials, ...
    'trials should be greater than min_trials.');
...
tc.verifyEqual(min_noise_to_delta_ratio, 0, ...
    'Without noise, min_noise_to_delta_ratio should be equal 0.');
